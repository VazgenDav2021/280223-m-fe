...
//         this.currentElement.append(ulElement);
...
// const header = new HTMLElement("header", 'header', document.body);
// const nav = new HTMLElement("nav", 'navs', header.currentElement)
// nav.renderElements(navigationLinks, 'li', 'navLinks');